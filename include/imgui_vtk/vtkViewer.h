...
class VtkViewer
{
  ...
  private:
    ...
    vtkSmartPointer<ui::MouseInteractorHighLightActor> interactorStyle;
  ...
  public:
    ...
    inline void
    setInteractorStyle(const vtkSmartPointer<ui::MouseInteractorHighLightActor>& interactorStyle)
    {
  ...
  public:
    ...
    inline vtkSmartPointer<ui::MouseInteractorHighLightActor>& getInteractorStyle()
    {
